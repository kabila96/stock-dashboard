...
with col2:
    ...
    corr = dfc[show_cols].corr(numeric_only=True)
    fig_c, axc = plt.subplots(figsize=(5.5, 5))
    sns.heatmap(corr, annot=True, fmt=".2f", cmap="Blues", ax=axc, square=True)
    axc.set_title("Correlation matrix")
